...
export const es: Dictionary = {
  ...
  controls: {
    ...
    suggestionReasonAuthenticCadence: "Cadencia auténtica — la dominante resuelve a la tónica",
    suggestionReasonPlagalCadence: "Cadencia plagal — la subdominante vuelve a la tónica",
    suggestionReasonDeceptiveCadence: "Cadencia rota — la dominante se desvía a la submediante",
    suggestionReasonTwoFive: "Movimiento ii–V — la preparación clásica de la dominante",
    suggestionReasonModalCadence: "Cadencia modal — la subtónica sube a la tónica",
    suggestionReasonLeadingResolve: "La sensible resuelve subiendo a la tónica",
    suggestionReasonToDominant: "Genera tensión hacia la dominante",
    suggestionReasonCommonMove: "Movimiento armónico habitual",
