...
export const BASS_PATCHES: readonly BassPatch[] = [
  {
    ...
    filterEnvelope: { attack: 0.01, decay: 0.3, sustain: 0, release: 0.3, baseFrequency: 120, octaves: 2.0 },
    volumeDb: -2,
  ...
  },
  {
    ...
    filterEnvelope: { attack: 0.005, decay: 0.2, sustain: 0.1, release: 0.2, baseFrequency: 250, octaves: 2.5 },
    volumeDb: -3,
  ...
  },
  {
    ...
    envelope: { attack: 0.002, decay: 0.2, sustain: 0.15, release: 0.2 },
    filter: { type: "lowpass", Q: 2 },
    filterEnvelope: { attack: 0.002, decay: 0.2, sustain: 0.15, release: 0.2, baseFrequency: 400, octaves: 3.5 },
    volumeDb: -3,
